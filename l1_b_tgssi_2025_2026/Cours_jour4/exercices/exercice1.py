...
stock = ["cable-rj45", "switch-8ports", "routeur-wifi", "cable-rj45", "point-acces", "switch-8ports", "cable-rj45"]
# LE NOMBRE D'ÉLEMENTS DANS LA LISTE

print("notre stock à : ", len(stock), "éléments")
# nom = "milandou"
# print("nombre de caractère:", len(nom))
